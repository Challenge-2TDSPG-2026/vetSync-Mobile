    ...
    <Animated.View style={[s.sheet, { paddingBottom: Math.max(insets.bottom, 8), transform: [{ translateY: deslocamento }] }]}>
      ...
      <View style={s.composer}>
        <View style={s.composerField}>
          ...
          <TextInput value={entrada} onChangeText={setEntrada} placeholder="Pergunte algo à SIA" placeholderTextColor={C.muted} style={s.input} multiline maxLength={1000} editable={!carregando} onSubmitEditing={() => enviar()} blurOnSubmit={false} />
        </View>
